---
title: "Modelos probabilísticos Continuos conocidos"
date: "`r Sys.Date()`"
...
![Modelo Exponencial](img_ModelosContinuos/Figure1.PNG){width=500px}
...
![](img_ModelosContinuos/Figure2.PNG){width=500px}
...
![](img_ModelosContinuos/Figure3.PNG){width=400x}
...
<!--![](img_ModelosContinuos/Figure4.PNG)-->

## Graficamente

![](img_ModelosContinuos/Figure5.PNG){width=500x}{width=500px}
...
![](img_ModelosContinuos/Figure6.PNG){width=500px}
...
![](img_ModelosContinuos/Figure7.PNG)
...
![](img_ModelosContinuos/Figure8.PNG){width=500px}